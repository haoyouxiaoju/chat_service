...
int main(int argc,char* argv[]){
    ...
    transmitServiceBuilder builder;
    ...
    builder.makeChannelManager(FLAGS_registry_host,FLAGS_base_service,FLAGS_user_service);
    ...
    builder.make_transmit_service(FLAGS_listen_port,FLAGS_rpc_timeout,FLAGS_rpc_threads);
    builder.make_regClient(FLAGS_registry_host,FLAGS_base_service+FLAGS_instance_name,FLAGS_access_host);

    transmitService::ptr service =  builder.build();
    service->start();
